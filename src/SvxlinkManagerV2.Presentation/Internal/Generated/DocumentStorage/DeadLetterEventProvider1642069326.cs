...
namespace Marten.Generated.DocumentStorage
{
    ...
    public sealed class DeadLetterEventBulkLoader1642069326 : Marten.Internal.CodeGeneration.BulkLoader<JasperFx.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string TEMP_LOADER_SQL = "COPY mt_doc_deadletterevent_temp(\"mt_dotnet_type\", \"id\", \"mt_expected_version\", \"mt_version\", \"data\") FROM STDIN BINARY";
        ...
        public const string OVERWRITE_WITH_VERSION_SQL = "update public.mt_doc_deadletterevent target SET data = source.data, mt_version = source.mt_version, mt_dotnet_type = source.mt_dotnet_type, mt_last_modified = transaction_timestamp() FROM mt_doc_deadletterevent_temp source WHERE source.id = target.id and target.mt_version = source.mt_expected_version";

        public const string CREATE_TEMP_TABLE_FOR_COPYING_SQL = "create temporary table mt_doc_deadletterevent_temp (like public.mt_doc_deadletterevent including defaults, \"mt_expected_version\" uuid)";
        ...
        public override async System.Threading.Tasks.Task LoadTempRowAsync(Npgsql.NpgsqlBinaryImporter writer, JasperFx.Events.Daemon.DeadLetterEvent document, Marten.Storage.Tenant tenant, Marten.ISerializer serializer, System.Threading.CancellationToken cancellation)
        {
            await writer.WriteAsync(document.GetType().FullName, NpgsqlTypes.NpgsqlDbType.Varchar, cancellation);
            await writer.WriteAsync(((JasperFx.Events.Daemon.DeadLetterEvent)document).Id, NpgsqlTypes.NpgsqlDbType.Uuid, cancellation);
