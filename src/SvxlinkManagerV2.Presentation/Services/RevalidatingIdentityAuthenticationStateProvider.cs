...
/// <summary>
/// Revalide périodiquement l'état d'authentification de l'utilisateur connecté.
/// Nécessaire pour Blazor Server afin que les changements de compte soient pris en compte.
/// </summary>
